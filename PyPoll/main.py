...
with open(csvpath) as datafile:
    ...
    StockhamPercent = round(stockhamVotes / total_votes * 100, 2)
    DeGettePercent = round(degetteVotes / total_votes * 100, 2)
    DoanePercent = round(doaneVotes / total_votes * 100, 2)
